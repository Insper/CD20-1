...
- [Aula 20 - Teste de Hipótese com teste z (fim) e teste t (início)](./aula20)
    - [Atividade de sala](./aula20/Aula20_Atividade_THparaMediaComVarianciaDesconhecida.ipynb)
- [Aula 21 - Teste de Hipótese para Média com Variância Desconhecida](./aula21)
    ...
    - [Exercícios APS](./aula21/Aula21_Exercicio_APS_ModeloProbabilistico_THparaMedia.ipynb)
...
- [Aula 23 - Regressão Múltipla](./aula23)
    - [Atividade de sala](./aula23/Aula23_Atividade_RegressaoMultipla.ipynb)
    - [Base de dados: auto_mpg_sub.csv](./aula23/auto_mpg_sub.csv)
